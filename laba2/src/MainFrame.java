...
// как компонент, совместно используемый в различных методах
    ...
    public Double calculate1(Double x, Double y, Double z) {
        return Math.sin(Math.sin(y) + Math.exp(Math.cos(y)) + z*z) * Math.pow(Math.sin(Math.PI*Math.pow(y,2) + Math.log(x)) , 0.25);
    }
...
// Создать область с полями ввода для X, Y, Z
        JLabel labelForX = new JLabel("Переменная X:");
        textFieldX = new JTextField("0", 10);
        textFieldX.setMaximumSize(textFieldX.getPreferredSize());
        JLabel labelForY = new JLabel("Переменная Y:");
        textFieldY = new JTextField("0", 10);
        textFieldY.setMaximumSize(textFieldY.getPreferredSize());
        JLabel labelForZ = new JLabel("Переменная Z:");
...
// Создать область для вывода результата
        JLabel labelForResult = new JLabel("Результат вычислений:");
//labelResult = new JLabel("0");
        textFieldResult = new JTextField("0,0", 30);
...
// Создать область для кнопок
        ...
        buttonReset.addActionListener(new ActionListener() {public void actionPerformed(ActionEvent ev) {
...
// Связать области воедино в компоновке BoxLayout
        ...
        textFieldM = new JTextField("0", 30);
